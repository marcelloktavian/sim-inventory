  ...
  <div class="card-body">
    <div class="table-responsive">
                  ...
                  <div class="form-group">
                     <div class="form-line">
                      <input type="text" name="jenis_barang" class="form-control" value="<?php echo $tampil['jenis_barang']; ?>" required/>	 
                  </div>
                  </div>
                      ...
                      <input type="button" name="kembali" value="Kembali" class="btn btn-info" onclick="window.location = '?page=jenisbarang';">
                  </form>
