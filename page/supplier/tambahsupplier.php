...
$no = mysqli_query($koneksi, "select kode_supplier from tb_supplier order by kode_supplier ASC limit 1");
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                            ...
                            <div class="form-group">
                               <div class="form-line">
								<textarea  type="text" name="alamat" class="form-control" rows="4" required></textarea>
